...
description: An overview of our socials and official Dusk channels. Here you can find information to join our communities and how to get involved in Dusk.
---
...
To ease you into the intricacies of Dusk, you might consider participating in the node running of our testnet, Nocturne: [run a Nocturne node](https://docs.dusk.network/operator/nocturne/node-running-guide).

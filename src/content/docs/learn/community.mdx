...
To ease you into the intricacies of Dusk, you might consider participating in the node running of our testnet, Nocturne: [run a Nocturne node](/operator/guides/node-running-guide).

...
:::note
🔮 With the term **regulated DeFi (RegDeFi)** we indicate the extension of **DeFi** protocols to include tokens representing or digitizing regulated financial assets on **DLT**. **RegDeFi** applications provide the necessary regulatory compliance to extend **DeFi** to regulated assets such as bonds, stocks, ETFs, etc.
:::

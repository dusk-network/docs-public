...
You have not be included in the genesis state. For the first dry-run on December the 29th we took a snapshot on December the 27th at 5 PM CET. If you staked afterwards, your stake has beenreflected on the second dry-run and mainnet.

...
- **Minimum Requirements:** Ensure you meet minimum amounts before interacting, 1 [LUX](/learn/glossary#lux) (in wei, 1 LUX = 10^9 wei) for depositing, 1000 DUSK for staking.

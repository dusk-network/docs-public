...
### **What happened after depositing?**
Your tokens have been on-ramped on Dusk mainnet, and a corresponding genesis balance has been issued on the Dusk mainnet on January 7th, 2025.

### **What if I missed the deadlines?**
You have not been able to participate in the genesis state of Dusk.

### **What if I missed the staking deadline?**
You have not be included in the genesis state. For the first dry-run on December the 29th we took a snapshot on December the 27th at 5 PM CET. If you staked afterwards, your stake has been reflected on the second dry-run and mainnet.

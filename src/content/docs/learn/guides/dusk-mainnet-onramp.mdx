...
## Depositing DUSK Tokens

The staking period has ended as of **December 28th, 23:59 CET**. Only **deposits** are now possible until **January 2nd, 23:59 CET**. Depositing ensures your funds are included in the genesis state of the Dusk mainnet but does not contribute to consensus or earn rewards.

**Recommendation:** If you did not stake before December 28th, you can still deposit DUSK tokens before the January 2nd deadline. Any DUSK not deposited by this date can only be migrated to the Dusk mainnet using the [mainnet migration bridge](/learn/guides/mainnet-migration) after January 7th.
...
- **Minimum Requirements:** Ensure you meet minimum amounts before interacting, 1 [LUX](/learn/glossary#lux) (in wei, 1 LUX = 10^9 wei, 1 DUSK = 10^18 wei) for depositing.
...
After depositing, verify your transaction status on Etherscan/BSCscan through your wallet. 
...
### **What if I missed the staking deadline?**
You will not be included in the genesis state. For the first dry-run on December the 29th we took a snapshot on December the 27th at 5 PM CET. If you staked afterwards, your stake will be reflected on the second dry-run and mainnet.

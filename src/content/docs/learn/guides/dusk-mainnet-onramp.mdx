...
<Tabs syncKey="network">
   ...
   4. **Amount:** Enter the number of tokens you plan to deposit or stake (in wei, 1 DUSK = 10^18 wei). You can add 18 decimals by clicking on the `+` icon next to `amount` field.
...
<Tabs syncKey="network">
   ...
   3. **Amount:** Enter the number of DUSK tokens to deposit (in wei). You can add 18 decimals by clicking on the `+` icon next to `amount` field.
...
<Tabs syncKey="network">
   ...
   3. **Amount:** Enter the number of DUSK tokens to stake (in wei). You can add 18 decimals by clicking on the `+` icon next to `amount` field.

...
sidebar_label: Why Dusk
---

import { Card, LinkCard, Icon } from '@astrojs/starlight/components';

<LinkCard title="TL;DR" description="The power of DeFi, the privacy of Fintech institutions, the control of FMIs - at the fingertip of all users"/>
...
<Card title="Mission">
<Icon name="rocket" color="grey" label="very beautiful"/>We empower users to fully control their assets
</Card>

<details class="info">
<summary>In depth explanation of Dusk's mission</summary>
...
<details class="info">
<summary>Expand to learn about **DeFi** advantages</summary>

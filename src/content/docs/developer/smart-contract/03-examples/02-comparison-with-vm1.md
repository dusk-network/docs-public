...
After a taste of how [a counter example smart contract looks in Piecrust](/getting-started/vm/03-examples/01-my-first-contract), it is worth to have a look at a functionally equivalent example written for Rusk-VM Version 1.0. An example looks as follows:

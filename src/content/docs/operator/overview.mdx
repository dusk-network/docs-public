...
<CardGrid>
        <LinkCard title="Mainnet Node" href="/operator/guides/mainnet-node" description="Run a provisioner node on mainnet and participate in consensus"/>
        <LinkCard title="Testnet Node" href="/operator/guides/nocturne-node" description="Run a provisioner node on testnet and participate in consensus"/>

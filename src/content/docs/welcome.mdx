...
To ease you into the intricacies of Dusk, you might consider participating in the [Staking](/itn/erc20-staking) initiative, or [run a provisioner](/getting-started/node-setup/build-from-source) in our upcoming Incentivized Testnet (ITN) program. 
